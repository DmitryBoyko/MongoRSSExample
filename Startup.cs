...
namespace MongoRSSExample
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IRSSDatabaseSettings>(sp => sp.GetRequiredService<IOptions<RSSDatabaseSettings>>().Value);
